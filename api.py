...
# Fonction 3.
# La fonction permet de lister l'historique de
# l'ensemble des parties jouées par un joueur sur un serveur.
# Elle accepte en entrée l'idul du joueur dont on souhaite avoir
# l'historique des parties. De plus, la fonction ne retourne
# rien, mais elle affiche à la console un json.
...
def jouer_coup(id_partie, type_coup, position):
    ...
    try:
        donnees = requests.post(url_coup, data={'id': id_partie,
